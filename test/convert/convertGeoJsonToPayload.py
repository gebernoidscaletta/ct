...
if __name__ == "__main__":
    ...
    input_folder = "Z:/Geofence/Kecamatan Indonesia/Converted/Bengkulu"
    output_folder = "Z:/Geofence/Kecamatan Indonesia/Converted/Bengkulu/Bengkulu-JSON"
